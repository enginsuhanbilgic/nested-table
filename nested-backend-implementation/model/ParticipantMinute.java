...
/**
 * One minute bucket of a participant's latency. Maps
 * stat.v_participant_minute. The view supplies a synthetic row_number() id
 * (query-scoped -- not a stable identifier).
 */
@Immutable
@Entity
@Table(name = "v_participant_minute", schema = "stat")
@Getter
@NoArgsConstructor
@AllArgsConstructor
public class ParticipantMinute {
