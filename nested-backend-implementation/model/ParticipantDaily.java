...
/**
 * One participant per trading day. Maps stat.v_participant_daily
 * (grp_type = 'participant' rows). The view supplies a synthetic
 * row_number() id (query-scoped -- not a stable identifier).
 */
@Immutable
@Entity
@Table(name = "v_participant_daily", schema = "stat")
@Getter
@NoArgsConstructor
@AllArgsConstructor
public class ParticipantDaily {
